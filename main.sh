...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To ULTRASONIC VPN SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}KOCHENG TUNNELING ® ${NC}${YELLOW}(${NC} ${green} KOCHENG VPN${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self KOCHENG TUNNELING ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/KochengVpn/v2/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/KochengVpn/izin/main/ip"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> KOCHENG VPN TUNNELING  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6283139274450"}]]}' 
...
wget -q https://raw.githubusercontent.com/KochengVpn/v2/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
